insert overwrite table temp.tmp_jjtj_t_user_max_retracement partition(init_date='20200904')
select cust_no uid,
       from_unixtime(unix_timestamp('20190904','yyyymmdd'),'yyyy-mm-dd') start_time,
	   from_unixtime(unix_timestamp('20200904','yyyymmdd'),'yyyy-mm-dd') end_time,
	   '1Y'  type,
...
where init_date between '20190904' and '20200904'
...
--where  a.cust_no='20921032'   --'20921032' '00019230' '00013706'
group by cust_no